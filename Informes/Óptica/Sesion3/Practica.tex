...
Al no tener un valor de referencia para el radio de curvatura de la lente esférica, no podemos calcular un error relativo entre los dos métodos. Sin embargo, podemos observar que ambos valores obtenidos son bastante cercanos entre sí, lo que sugiere que ambos métodos son válidos y proporcionan resultados consistentes.

...
A continuación, empleamos la expresión proporcionada por el informe \cite{InfoOpticaPrisma}, $\delta = |L - L_0|$, para calcular el ángulo de desviación mínima para cada longitud de onda, este ángulo lo usaremos más adelante para obtener los valores requeridos. Exponemos los resultados:\footnote{Los valores del amarillo pasarán a llamarse $D$, los del rojo $C$ y los del azul $F$.}
\begin{table}[H]
\centering
\begin{tabular}{|r|r|r|}
\hline
...
Con los datos del apartado anterior,  sabiendo que el ángulo de refringencia del prisma tratado es de 60º sin incertidumbre podemos calcular el índice de refracción del prisma para cada longitud de onda. Para ello utilizamos la siguiente expresión: 
\[
...
\rowcolor[rgb]{.816,  .816,  .816}1,54029 & 0,00008 & 1,53134 & 0,00008 & 1,52928 & 0,00008 \\ \hline
\rowcolor[rgb]{.816,  .816,  .816}1,54879 & 0,00008 & 1,53843 & 0,00008 & 1,53806 & 0,00008 \\ \hline
\rowcolor[rgb]{.816,  .816,  .816}1,54362 & 0,00008 & 1,53153 & 0,00008 & 1,53115 & 0,00008 \\ \hline
\end{tabular}
\caption{Valores obtenidos del índice de refracción para cada longitud de onda.}\label{tab:indice_refraccion}
\end{table}
De nuevo, la relación de tamaños entre ellos es la esperada, $n_f$ mayor que $n_c$ mayor que $n_d$, lo que apunta a que el desarrollo está siendo correcto. Además, el valor se encuentra en consonancia con el índice de refracción del vidrio, en torno a 1,5.
...
En este caso este error se debe al uso del nonius, cuya precisión es de $\delta_x=0,0167$ unidades. 

...
Con estos datos, obtenemos el valor promedio de $s = 3,03\,\pm\,0,02$\,mm. La desviación estándar de las tres medidas es $\sigma \approx 0,032$\,mm, por lo que consideramos que tres medidas son suficientes para este caso (más repeticiones apenas reducirían $u_A$). Obsérvese que en la expresión posterior de la longitud de onda aparece un factor 3 en el denominador: proviene de que $s$ incluye tres espaciamientos, de modo que la interfranja individual es $s/3$.
